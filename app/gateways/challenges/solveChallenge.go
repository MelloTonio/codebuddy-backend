...
func (h ChallengeHandler) SolveChallenge(w http.ResponseWriter, r *http.Request) {
	...
	codeOutput, err := h.service.SolveChallenge(context.Background(), challenges.Challenge{
	...
	response.JSON(w, http.StatusCreated, codeOutput)
}
